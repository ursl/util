...
public :
  ...
  virtual void   overlay(TH1* h1, std::string f1, TH1 *h2, std::string f2, bool legend = true);
  virtual void   overlay(std::string f1, std::string h1name, std::string f2, std::string h2name, bool legend = true);
